...
class GtpConnection():
    ...
    def get_cmd(self, command):
        ...
        if command_name != "play" and self.arg_error(command_name, len(args)) :
            return
        elif command_name == "play" and self.argmap[command_name][0] > len(args):
